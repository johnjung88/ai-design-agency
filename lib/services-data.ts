...
export const servicesData: ServiceDetail[] = [
  ...
  },
  {
    ...
    pricing: [
      ...
      {
        name: { ko: "풀브랜딩", en: "Full branding" },
        eventPrice: "₩100,000~",
        regularPrice: "₩400,000~",
        duration: "3일",
        includes: [
          { ko: "로고 시스템", en: "Logo system" },
          { ko: "명함 및 프로필 키트", en: "Business card and profile kit" },
          { ko: "간단 브랜드 가이드", en: "Simple brand guide" },
        ],
      },
    ],
