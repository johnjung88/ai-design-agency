...
export const hotItems: HotItem[] = [
  ...
  },
  {
    ...
    description: { ko: "상위 판매자보다 합리적인 가격, 저가 상품보다 높은 완성도로 로고·명함·목업까지 빠르게 세팅합니다.", en: "Fast logo, card, and mockup setup at launch-event pricing." },
    price: { ko: "2.9만원~", en: "from ₩29,000" },
    duration: { ko: "1일", en: "1 day" },
    proof: { ko: "5월 입점 이벤트 한정가", en: "May launch event price" },
