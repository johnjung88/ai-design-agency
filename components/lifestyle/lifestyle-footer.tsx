  ...
  return (
    <footer
      style={{
        ...
        borderTop: "1px solid var(--tone-life-rose)",
    ...
    >
      <div className="mx-auto w-full max-w-[1400px] px-6 lg:px-12 py-14">
            ...
            <div className="flex flex-wrap gap-2 mt-1">
              {channels.map((c) => (
                <Link
                  key={c.id}
                  href={c.href}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full transition-all hover:-translate-y-0.5 hover:!border-[var(--tone-life-rose)] hover:!text-[var(--tone-life-rose)]"
                  style={{
                    background: "transparent",
                    color: "var(--tone-life-ink)",
                    border: "1px solid var(--tone-life-line-2)",
                ...
                if (d.available && d.href) {
                  return (
                    <Link
                      key={d.label}
                      href={`${base}${d.href}`}
                      className="transition-colors hover:!text-[var(--tone-life-rose)]"
                      style={linkStyle}
                    >
                      {d.label}
                    </Link>
        ...
        {/* Business info — 2 lines */}
        <div
          className="mt-14 pt-6 text-center"
          style={{ borderTop: "1px solid var(--tone-life-line-2)" }}
        >
          <div
            style={{
              fontFamily: "var(--font-jetbrains)",
